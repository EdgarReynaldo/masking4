...
void MAS::Label::MsgInitSkin() {
	for (int i=0; i<4; i++) {
		if (GetFontColor(i) == -1) SetFontColor(skin->fcol[Skin::INFO_TEXT][i], skin->scol[Skin::INFO_TEXT][i], i);
