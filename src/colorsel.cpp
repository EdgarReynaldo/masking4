	...
	:Window()
{
	...
	bOK.Setup(112,188,  96,22, KEY_O, D_EXIT, "&OK");
	bCancel.Setup(216,188, 96, 22, KEY_C, D_EXIT, "&Cancel");
...
void MAS::ColorSelect::HandleEvent(Widget &obj, int msg, int arg1, int arg2) {
