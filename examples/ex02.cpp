...
class MyDialog : public Dialog {
	...
	public:
		MyDialog() : Dialog() {
			...
			b[0].Setup(200, 200, 120, 24, KEY_O, D_EXIT | D_TOGGLE, "&OK");
			b[1].Setup(200, 230, 120, 24, KEY_Q, D_EXIT | D_TOGGLE, "Cancel");
			b[2].Setup(200, 260, 120, 24, KEY_D, D_EXIT | D_TOGGLE | D_DISABLED, "&Disabled");
			b[3].Setup(200, 290, 120, 24, KEY_H, D_EXIT | D_TOGGLE | D_HIDDEN, "&Hidden");
			b[4].Setup(200, 320, 120, 24, KEY_T, D_TOGGLE, "&Toggle me");
			wb[0].Setup(340, 200, 120, 24, KEY_K, D_EXIT, "O&K");
			wb[1].Setup(340, 230, 120, 24, KEY_L, D_EXIT, "Cance&l");
			wb[2].Setup(340, 260, 120, 24, KEY_B, D_EXIT | D_DISABLED, "Disa&bled");
			wb[3].Setup(340, 290, 120, 24, KEY_N, D_EXIT | D_HIDDEN, "Hidde&n");
			wb[4].Setup(340, 320, 120, 24, KEY_P, 0, "&Push me");
			...
			sc[0].Setup(KEY_D, KB_ALT_FLAG);
			sc[1].Setup(KEY_PLUS_PAD);
			sc[2].Setup(KEY_MINUS_PAD);
